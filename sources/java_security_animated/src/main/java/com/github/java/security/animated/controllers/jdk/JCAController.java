...
public class JCAController extends BaseController {

	private static final String SNIPPET_PATH_INTRO = "/snippets/jdk/jca/intro.txt";

	public JCAController(MainDisplayPanel displayPanel) {
		super(displayPanel);
